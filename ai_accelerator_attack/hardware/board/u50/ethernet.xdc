# QSFP28 Interfaces
set_property -dict {LOC J45} [get_ports qsfp0_rx1_p]
set_property -dict {LOC J46} [get_ports qsfp0_rx1_n]
set_property -dict {LOC D42} [get_ports qsfp0_tx1_p]
set_property -dict {LOC D43} [get_ports qsfp0_tx1_n]
...
set_property PACKAGE_PIN N37 [get_ports qsfp0_mgt_refclk_1_n]
set_property PACKAGE_PIN N36 [get_ports qsfp0_mgt_refclk_1_p]
